...
public class MenuSpriteServiceTest {
    ...
    public void menuSpriteFunctions() {
        ...
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(Mockito.mock(MainMenuScreen.class)));
        ...
        // test invalid throws error
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(GdxGame.ScreenType.MAIN_MENU));



        // test dynamic sprite get by screen and enum
        try {
            MenuSpriteData msd = menuSpriteService.getMenuSprite(Mockito.mock(MainMenuScreen.class), anEnum.ITEM1);
            assertEquals(msd, msd1);
        } catch (MenuSpriteNotFoundException e) {
            assertNull(e);
        }
        // invalid ID to throw error
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(Mockito.mock(MainMenuScreen.class), anEnum.ITEM2));
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(Mockito.mock(SettingsScreen.class), anEnum.ITEM1));
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(Mockito.mock(SettingsScreen.class), anEnum.ITEM2));



        // test dynamic sprite get by screentype and enum
        try {
            MenuSpriteData msd = menuSpriteService.getMenuSprite(GdxGame.ScreenType.MAIN_MENU, anEnum.ITEM1);
            assertEquals(msd, msd1);
        } catch (MenuSpriteNotFoundException e) {
            assertNull(e);
        }
        // invalid ID to throw error
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(GdxGame.ScreenType.MAIN_MENU, anEnum.ITEM2));
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(GdxGame.ScreenType.SETTINGS, anEnum.ITEM1));
        assertThrows(MenuSpriteNotFoundException.class, () -> menuSpriteService.getMenuSprite(GdxGame.ScreenType.SETTINGS, anEnum.ITEM2));
    }
}
