...
class ProfileServiceTest {
  ...
  void testCreateProfileInvalidSlot() {
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.createProfile("TestProfile", 0));
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.createProfile("TestProfile", 4));
  }
  ...
  void testLoadProfileNullSavefile() {
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.loadProfile(null));
  }
  ...
  void testSaveProfileToSlotInvalidSlot() {
    ...
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.saveProfileToSlot(0));
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.saveProfileToSlot(4));
  }

  @Test
  void testGetAllSaves() {
    try (MockedStatic<Persistence> persistenceMock = mockStatic(Persistence.class)) {
      List<Savefile> mockSaves = Arrays.asList(
  ...
  void testGetSaveFromSlotInvalidSlot() {
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.getSaveFromSlot(0));
    assertThrows(IllegalArgumentException.class, () -> 
        profileService.getSaveFromSlot(4));
  }
