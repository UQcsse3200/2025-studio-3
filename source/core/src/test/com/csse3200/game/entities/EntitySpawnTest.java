  ...
  void spawnEnemiesCheckWeightAndMinimum() {
    ...
    void chanceProportionsRespectedDeterministically() {
        ...
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 20; }
                    @Override
                    public int getMinZombiesSpawn() { return 0; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
    ...
    void zeroChanceTypesDoNotAppearWhenOthersPositive() {
        ...
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 14; }
                    @Override
                    public int getMinZombiesSpawn() { return 0; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
    ...
    void allZeroChancesBecomeEqualWeights() {
        // All chances = 0 -> treat as equal weights; with 3 types, budget for 6 spawns -> expect 2 each (deterministic SWRR)
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 12; } // cost=2 -> 6 spawns
                    @Override
                    public int getMinZombiesSpawn() { return 0; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
    ...
    void enforcesMinimumViaCheapestCostWhenBudgetTooSmall() {
        ...
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 1; } // insufficient
                    @Override
                    public int getMinZombiesSpawn() { return 4; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
                        Map<String, BaseSpawnConfig> m = new HashMap<>();
    ...
    void expensiveTypesAreSkippedWhenUnaffordable() {
        ...
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 5; }
                    @Override
                    public int getMinZombiesSpawn() { return 0; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
    ...
    void deterministicOrderWithTiesAlternatesAlphabetically() {
        ...
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 8; } // cost=2 -> 4 spawns
                    @Override
                    public int getMinZombiesSpawn() { return 0; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
    ...
    void zeroCostTypesAreSkippedToAvoidInfiniteLoops() {
        ...
        WaveService ws =
                new WaveService() {
                    @Override
                    public int getWaveWeight() { return 6; } // cost 2 -> 3 spawns
                    @Override
                    public int getMinZombiesSpawn() { return 0; }
                    @Override
                    public Map<String, BaseSpawnConfig> getEnemyConfigs() {
