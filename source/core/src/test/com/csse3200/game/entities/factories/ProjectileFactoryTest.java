...
class ProjectileFactoryTest {
  ...
  void testCreateBossProjectile() {
    ...
    assertNotNull(
        bossProj.getComponent(PhysicsComponent.class),
        "Boss projectile should have PhysicsComponent");
    assertNotNull(
        bossProj.getComponent(ColliderComponent.class),
        "Boss projectile should have ColliderComponent");
    assertNotNull(
        bossProj.getComponent(HitboxComponent.class),
        "Boss projectile should have HitboxComponent");
    assertNotNull(
        bossProj.getComponent(TouchAttackComponent.class),
        "Boss projectile should have TouchAttackComponent");
    assertNotNull(
        bossProj.getComponent(CombatStatsComponent.class),
        "Boss projectile should have CombatStatsComponent");
    assertNotNull(
        bossProj.getComponent(TextureRenderComponent.class),
