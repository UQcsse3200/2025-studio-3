...
class LaneRunnerPlayerCollisionComponentTest {
  @Mock private MinigameService mockMinigameService;

  private LaneRunnerPlayerCollisionComponent collisionComponent;
  ...
  void testComponentCreation() {
    ...
    LaneRunnerPlayerCollisionComponent component = new LaneRunnerPlayerCollisionComponent();
  ...
  void testComponentType() {
    ...
    assertTrue(collisionComponent instanceof LaneRunnerPlayerCollisionComponent);
  }
