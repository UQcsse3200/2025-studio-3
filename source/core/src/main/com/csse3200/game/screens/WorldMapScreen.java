...
public class WorldMapScreen implements Screen {
    ...
    public void show() {
        ...
        // Back button (image) with hover pop
        ...
        backBtn.setTransform(true); // allow scaling
    ...
    public void render(float delta) {
        ...
        if (hoveringBack) {
            ...
            uiShapes.setColor(1f, 1f, 0f, 0.35f); // yellow glow
    ...
    // Convert mouse (screen) → world coords for hover tests
