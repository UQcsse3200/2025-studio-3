...
public class WorldMapScreen extends BaseScreen {
    ...
    /**
     * Pans the camera by the given screen-space delta (in pixels). Dragging moves the view
     * with the cursor (grab-and-drag behavior).
     */
    ...
    private void playDevCutsceneIfExists(String bareName) {
        ...
        ServiceLocator.getCutsceneService().playCutscene(bareName, id -> { /* no-op */ });
    }
}
