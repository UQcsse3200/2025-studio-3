...
/**
 * The screen that displays the Skill Tree and handles skill unlocking
 * mechanics.
 * Provides UI for skill buttons, shows skill points, and handles user
 * interaction.
...
public class SkillTreeScreen extends ScreenAdapter {
  ...
  /**
   * Sets up the UI elements: background, skill points display, input handling,
   * and skill buttons.
   */
  ...
  private void createAllButtons() {
    ...
    // Damage Skills
    createSkillButton(stage, "Increase AD Basic", "Damage 10%", lockedTexture, unlockedTexture, 0.32f * width,
        0.52f * height);
    createSkillButton(stage, "Increase AD Intermediate", "Damage 20%", lockedTexture, unlockedTexture, 0.19f * width,
        0.38f * height);
    createSkillButton(stage, "Increase AD Advanced", "Damage 30%", lockedTexture, unlockedTexture, 0.07f * width,
        0.16f * height);

    // Firing Skills
    createSkillButton(stage, "Increase firing Basic", "Firing Speed 10%", lockedTexture, unlockedTexture, 0.29f * width,
        0.35f * height);
    createSkillButton(stage, "Increase firing Intermediate", "Speed 20%", lockedTexture, unlockedTexture,
        0.305f * width, 0.18f * height);
    createSkillButton(stage, "Increase firing Advanced", "Firing Speed 30%", lockedTexture, unlockedTexture,
        0.26f * width, 0.15f * height);

    // Crit Skills
    createSkillButton(stage, "Increase crit Basic", "Crit 10%", lockedTexture, unlockedTexture, 0.45f * width,
        0.205f * height);
    createSkillButton(stage, "Increase crit Basic", "Crit 20%", lockedTexture, unlockedTexture, 0.835f * width,
        0.20f * height);

    // Health Skills
    createSkillButton(stage, "Increase Health Basic", "Health 10%", lockedTextureShield, unlockedTextureShield,
        0.56f * width, 0.575f * height);
    createSkillButton(stage, "Increase Health Intermediate", "Health 20%", lockedTextureShield, unlockedTextureShield,
        0.475f * width, 0.46f * height);
    createSkillButton(stage, "Increase Health Advanced", "Health 30%", lockedTextureShield, unlockedTextureShield,
        0.455f * width, 0.31f * height);

    // Armour Skills
    createSkillButton(stage, "Increase armour Basic", "Armour 10%", lockedTextureShield, unlockedTextureShield,
        0.62f * width, 0.47f * height);
    createSkillButton(stage, "Increase armour Intermediate", "Armour 20%", lockedTextureShield, unlockedTextureShield,
        0.565f * width, 0.25f * height);
    createSkillButton(stage, "Increase armour Advanced", "Armour 30%", lockedTextureShield, unlockedTextureShield,
        0.665f * width, 0.25f * height);
  }
