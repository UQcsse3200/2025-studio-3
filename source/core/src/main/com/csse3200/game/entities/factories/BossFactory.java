...
public class BossFactory {
    ...
    private static Entity createBaseBoss(BaseBossConfig config) {
        ...
        AnimationRenderComponent animator = new AnimationRenderComponent(ServiceLocator.getResourceService().getAsset(config.atlasFilePath,TextureAtlas.class));
       ...
       // animator.addAnimation("attackDamaged",0.1f, Animation.PlayMode.LOOP);
        ...
        ColliderComponent colliderComponent = new ColliderComponent()
                 .setCollisionFilter(
                        PhysicsLayer.BOSS, (short) (PhysicsLayer.DEFAULT | PhysicsLayer.NPC | PhysicsLayer.OBSTACLE))
                .setFriction(0f);
