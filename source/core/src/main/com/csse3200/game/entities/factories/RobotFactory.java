...
public class RobotFactory {
   ...
   * robots. Note: Gunner Robot does not currently spawn (probability of spawning was set to 0 to
   * stop it from spawning from levels.json due to projectile issues)
   *
