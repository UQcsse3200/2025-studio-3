...
public class LaneRunnerGameOverDisplay extends UIComponent {
    private static final Logger logger = LoggerFactory.getLogger(com.csse3200.game.minigame.LaneRunnerGameOverDisplay.class);
    ...
    private void addActors() {
        ...
        Label TimeLabel = new Label("Survival Time: " + String.format("%.2f", survivalTime) + "s", skin);
