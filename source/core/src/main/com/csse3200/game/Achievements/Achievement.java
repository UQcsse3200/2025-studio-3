...
/**
 * The Achievement class is responsible for unlocking achievements. It stores the names, description and skillpoint
 * of each individual achievement.
 * Achievements are tied to a particular profile/load file. Achievements are unlocked based on the
 * specified unlocking citeria(s).
 * Achievements are initialised to be locked.
 */
...
public class Achievement {
    ...
    /**
     * unlocks the achievement. Pops up on current screen indicating the associated achievement has been unlocked.
