...
/**
 * Service for managing the menu/map sprites. Contains methods for registering, and getting a list
 * and individual sprite data.
 */
public class MenuSpriteService {
  ...
  /**
   * **** FOR STATIC MENU SPRITES **** Gets a specific MenuSpriteData from the appropriate screen.
   *
   ...
   * @throws MenuSpriteNotFoundException when no MenuSpriteData can be found.
   */
  public MenuSpriteData getMenuSprite(GdxGame.ScreenType screenType)
      throws MenuSpriteNotFoundException {
  ...
  /**
   * **** FOR DYNAMIC MENU SPRITES ONLY **** Gets a specific MenuSpriteData for a given screen and
   * enum ID.
   *
   * @param screen - GameScreen to get data for.
   ...
   * @throws MenuSpriteNotFoundException when no MenuSpriteData can be found.
   */
  public MenuSpriteData getMenuSprite(Screen screen, Enum<?> id)
      throws MenuSpriteNotFoundException {
    for (MenuSpriteData menuSpriteData : getMenuSprites()) {
  ...
  /**
   * **** FOR DYNAMIC MENU SPRITES ONLY **** Gets a specific MenuSpriteData for a given ScreenType
   * and enum ID.
   *
   * @param screenType - GdxGame ScreenType of the sprite desired.
   ...
   * @throws MenuSpriteNotFoundException when no MenuSpriteData can be found.
   */
  public MenuSpriteData getMenuSprite(GdxGame.ScreenType screenType, Enum<?> id)
      throws MenuSpriteNotFoundException {
