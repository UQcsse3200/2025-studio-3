...
public enum AudioBus {
  /** For (usually) single, quick audio effects. E.g. explosion, door opening, crash. */
  SFX,

  /** For long-lasting and (usually) looping soundtracks. E.g. ambiance, or background music. */
  MUSIC;
