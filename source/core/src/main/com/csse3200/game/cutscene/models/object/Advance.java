...
public class Advance {
  ...
  /**
   * Creates an {@code Advance} with parameter details This is NOT to be used, rather use provided
   * static methods (e.g. {@link Advance#auto()}.
   *
  ...
  /**
   * Get an {@code Advance} configured for {@link AdvanceMode#INPUT}. No delay or signal key are
   * used.
   *
  ...
  /**
   * Get an {@code Advance} configured for {@link AdvanceMode#AUTO}. No delay or signal key are
   * used.
   *
  ...
  /**
   * Get an {@code Advance} configured for {@link AdvanceMode#AUTO_DELAY}. No signal key is set.
   *
  ...
  /**
   * Get an {@code Advance} configured for {@link AdvanceMode#SIGNAL}. No delay is set.
   *
