...
public class CharacterEnterAction implements ActionState {
    ...
    public CharacterEnterAction(CharacterState characterState, CharacterEnterData characterEnterData) {
        ...
        this.characterState.setTexture(new SpriteDrawable(
                new Sprite(
                        new Texture(characterEnterData.character()
                                .getPoses()
                                .get(characterEnterData.pose())
                        )
                ))
        );
