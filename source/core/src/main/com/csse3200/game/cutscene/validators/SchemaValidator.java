 ...
 * Schema validators are built up of {@link ActionValidator}s which combine to validate a given schema.
 * Schemas will change with time and will need new validators, so this interface ensures they can be easily swapped.
 */
