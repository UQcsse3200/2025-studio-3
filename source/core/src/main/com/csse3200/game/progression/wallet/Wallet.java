...
/**
 * The Wallet class enables a player to collect, store and spend coins and
 * skills points which allow purchase of Shop Items and unlocking of Skills to
 * use in-level.
 *
...
public class Wallet {
  ...
  /** 
   * Purchases Shop Item where Wallet has sufficient coins, and returns true,
