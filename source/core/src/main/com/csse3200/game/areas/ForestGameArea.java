...
/** Forest area for the demo game with trees, a player, some enemies, robots, and currency spawns. */
public class ForestGameArea extends GameArea {
    private static final Logger logger = LoggerFactory.getLogger(ForestGameArea.class);

    private static final int NUM_TREES = 7;
    private static final int NUM_ROBOTS = 7;  // from your branch
    private static final int NUM_GHOSTS = 2;  // from currency branch
    ...
    private static final String[] forestTextures = {
            ...
            "images/robot_placeholder.png",  // from your branch
            "images/normal_sunlight.png"     // from currency branch
    };
    ...
    private static final String[] forestTextureAtlases = {
            ...
            "images/robot_placeholder.atlas"  // from your branch
    };
    ...
    public void create() {
        ...
        spawnGhosts();
        spawnGhostKing();
        spawnRobots();   // keep your robots
        spawnSun();      // add currency spawns
    ...
    private void spawnGhosts() {
        ...
        for (int i = 0; i < NUM_GHOSTS; i++) {
            ...
            // if your branch listens to "despawnGhost", you can re-add it like:
    ...
    private void spawnRobots() {
        ...
        for (int i = 0; i < NUM_ROBOTS; i++) {
            ...
            // keep your despawn event wiring
            robot.getEvents().addListener("despawnRobot", (Entity e) -> requestDespawn(e));
            robots.add(robot);
        }
    }

    // Optional helper if you want a direct call to remove a robot
    ...
    // ===== currency spawn (from feat/currency) =====
