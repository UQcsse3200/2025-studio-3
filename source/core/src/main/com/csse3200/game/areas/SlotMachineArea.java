 ...
 */
public class SlotMachineArea extends GameArea implements AreaAPI, EnemySpawner {

  private static final Logger logger = LoggerFactory.getLogger(SlotMachineArea.class);
