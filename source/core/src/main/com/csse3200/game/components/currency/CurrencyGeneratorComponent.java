...
/**
 * Periodically spawns "sunlight" currency at random positions on the screen.
 * The spawn interval, sun value, texture path and motion parameters are configurable.
 * Actions registered on the Stage are removed in {@link #dispose()} to avoid leaks.
 */
