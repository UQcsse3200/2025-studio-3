...
/**
 * A component to watch the given entity's health, and trigger the "spawnMinion" event when the
 * health goes below a threshold fraction of the maximum.
 */
public class CarrierHealthWatcherComponent extends Component {
  ...
  /**
   * Initialises the health watcher component with a threshold. This threshold should be between 0
   * and 1, and will be clamped to this if not. When the entity's health falls below maxHp *
   * thresholdFrac the minion will be spawned.
   *
  ...
  /**
   * Update function. When the entity goes below half health, triggers the "spawnMinion" event
   * listener.
   */
  @Override
  public void update() {
