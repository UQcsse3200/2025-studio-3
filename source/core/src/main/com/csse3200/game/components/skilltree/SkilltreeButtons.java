...
/**
 * UI component responsible for creating and managing buttons and labels
 * for the skill tree screen. Includes functionality for back navigation,
 * skill unlocking buttons, and displaying total skill points.
 */
public class SkilltreeButtons extends UIComponent {
    ...
    private void createSkillButton(
        ...
        skillButton.addListener(
                new SkilltreeActions(skillName, skillSet, unlockedTexture, skillButton, stage, skillPointLabel, display));
    ...
    /**
     * Creates all skill buttons for the skill tree including Basic, Intermediate,
    ...
    private void createAllButtons(SkilltreeDisplay display) {
        ...
        Texture unlockedAttackExpert = new Texture(Gdx.files.internal("images/attack_expert_unlocked.png"));

        Texture lockedHealthExpert = new Texture(Gdx.files.internal("images/health_expert_locked.png"));
        Texture unlockedHealthExpert = new Texture(Gdx.files.internal("images/health_expert_unlocked.png"));

        Texture lockedSpeedExpert = new Texture(Gdx.files.internal("images/speed_expert_locked.png"));
        Texture unlockedSpeedExpert = new Texture(Gdx.files.internal("images/speed_expert_unlocked.png"));

        Texture lockedCritExpert = new Texture(Gdx.files.internal("images/speed_expert_locked.png"));
        Texture unlockedCritExpert = new Texture(Gdx.files.internal("images/speed_expert_unlocked.png"));

        Texture lockedCurrencyExpert = new Texture(Gdx.files.internal("images/currency_expert_locked.png"));
        Texture unlockedCurrencyExpert = new Texture(Gdx.files.internal("images/currency_expert_unlocked.png"));

        // Basic, Intermediate, Advanced, Expert skill buttons
        createSkillButton(stage, "Attack Basic", "Attack Damage", basicLocked, basicUnlocked, 0.09f * width, 0.1f * height, display);
        createSkillButton(stage, "Firing Speed Basic", "Firing Speed", basicLocked, basicUnlocked, 0.23f * width, 0.11f * height, display);
        createSkillButton(stage, "Health Basic", "Health", basicLocked, basicUnlocked, 0.42f * width, 0.09f * height, display);
        createSkillButton(stage, "Currency Basic", "Currency Generation", basicLocked, basicUnlocked, 0.69f * width, 0.105f * height, display);
        createSkillButton(stage, "Crit Basic", "Critical Chance", basicLocked, basicUnlocked, 0.88f * width, 0.1f * height, display);

        // Intermediate Skills
        createSkillButton(stage, "Attack Intermediate", "", intLocked, intUnlocked, 0.06f * width, 0.25f * height, display);
        createSkillButton(stage, "Firing Speed Intermediate", "", intLocked, intUnlocked, 0.24f * width, 0.27f * height, display);
        createSkillButton(stage, "Health Intermediate", "", intLocked, intUnlocked, 0.46f * width, 0.26f * height, display);
        createSkillButton(stage, "Currency Intermediate", "", intLocked, intUnlocked, 0.695f * width, 0.25f * height, display);
        createSkillButton(stage, "Crit Intermediate", "", intLocked, intUnlocked, 0.875f * width, 0.25f * height, display);

        // Advanced Skills
        createSkillButton(stage, "Attack Advanced", "", advancedLocked, advancedUnlocked, 0.05f * width, 0.42f * height, display);
        createSkillButton(stage, "Firing Speed Advanced", "", advancedLocked, advancedUnlocked, 0.21f * width, 0.45f * height, display);
        createSkillButton(stage, "Health Advanced", "", advancedLocked, advancedUnlocked, 0.42f * width, 0.44f * height, display);
        createSkillButton(stage, "Currency Advanced", "", advancedLocked, advancedUnlocked, 0.65f * width, 0.43f * height, display);
        createSkillButton(stage, "Crit Advanced", "", advancedLocked, advancedUnlocked, 0.85f * width, 0.41f * height, display);

        // Expert Skills
        createSkillButton(stage, "Attack Expert", "", lockedAttackExpert, unlockedAttackExpert, 0.135f * width, 0.6295f * height, display);
        createSkillButton(stage, "Firing Speed Expert", "", lockedSpeedExpert, unlockedSpeedExpert, 0.23f * width, 0.629f * height, display);
        createSkillButton(stage, "Crit Expert", "", lockedCritExpert, unlockedCritExpert, 0.86f * width, 0.629f * height, display);
        createSkillButton(stage, "Health Expert", "", lockedHealthExpert, unlockedHealthExpert, 0.34f * width, 0.631f * height, display);
        createSkillButton(stage, "Currency Expert", "", lockedCurrencyExpert, unlockedCurrencyExpert, 0.6f * width, 0.631f * height, display);
    }
