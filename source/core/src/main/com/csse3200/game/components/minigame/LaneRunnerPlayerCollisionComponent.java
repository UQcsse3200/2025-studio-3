...
public class LaneRunnerPlayerCollisionComponent extends Component {
  private static final Logger logger =
      LoggerFactory.getLogger(LaneRunnerPlayerCollisionComponent.class);
  ...
  private void onCollisionStart(Fixture thisFixture, Fixture otherFixture) {
    ...
    LaneRunnerObstacleComponent obstacle =
        otherUserData.getEntity().getComponent(LaneRunnerObstacleComponent.class);
    if (obstacle == null) {
