 ...
 * Every fixed cooldown, roll a chance and (if successful) jump to a different lane Y.
 * Keeps X constant; chooses Y from the provided laneYs[].
 */
public class TeleportTask extends Component {
    ...
    /**
     * Returns true if no other entity is already occupying roughly (x,targetY).
     * Uses the entity's scaled height as a proxy for tile size to derive tolerances.
     */
