...
public class HudDisplay extends UIComponent {
    ...
    private void createHudElements() {
        ...
        float goldDisplayX = rightEdge - PROFILE_BUTTON_SIZE - elementSpacing - 100f; // 100px for gold display width
    ...
    private void createProfileButton(float x, float y) {
        ...
        Texture profileTexture = ServiceLocator.getResourceService()
            .getAsset("images/profile.png", Texture.class);
    ...
    public void updateGoldDisplay() {
        try {
            ...
            int coins = 100; //ServiceLocator.getProfileService().get().wallet().getCoins();
