 ...
 * It handles user interactions with individual skill buttons:
...
public class SkilltreeActions extends ClickListener {
    ...
    private final Sound clickSound =
            Gdx.audio.newSound(Gdx.files.internal("sounds/skill_click.mp3"));

    /** Sound played when hovering over a skill button. */
    private final Sound hoverSound =
            Gdx.audio.newSound(Gdx.files.internal("sounds/skill_hover.mp3"));
     ...
     * Plays a click sound and displays the unlock popup for the associated skill.
     *
     ...
     * Plays a hover sound and scales the button up slightly for visual feedback.
     *
     * @param event the input event
     ...
     * Scales the button back to its original size.
     *
     * @param event the input event
     * @param x x-coordinate of the cursor
     * @param y y-coordinate of the cursor
