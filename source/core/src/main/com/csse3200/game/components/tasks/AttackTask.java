...
public class AttackTask extends TargetDetectionTasks {
     ...
     *
     * @return {@code 1} if a target is visible, in the same lane, and within attack range, otherwise {@code -1}
     */
    @Override
     ...
     *
     * @return {@code 1} if the target is visible, in the same lane, and within attack range, otherwise {@code -1}
     */
    @Override
    ...
    /**
     * Checks if the target entity is in the same lane as the owner entity.
     * A lane is defined by the y-coordinate, and entities are considered in the
     * same lane if their vertical distance is less than half a tile size.
     *
