...
public class DesktopLauncher {
  public static void main(String[] arg) {
    DeserializedSettings deserializedSettings = FileLoader.readClass(DeserializedSettings.class, "The Day We Fought Back" + File.separator + "settings.json", FileLoader.Location.EXTERNAL);
